...
{
    public class JahresvergleichRepo : RepositoryBaseEF<Jahresvergleich>
    {
        /// <summary>
        ...
        public override Jahresvergleich GetSingle<P>(P pkValue)
        {
        ...
        public override void Add(Jahresvergleich entity)
        {
            throw new NotImplementedException();
        }
        ...
        public override void Delete(Jahresvergleich entity)
        {
            throw new NotImplementedException();
        }
        ...
        public override void Update(Jahresvergleich entity)
        {
        }
        ...
        /// <returns></returns>
        public override IQueryable<Jahresvergleich> GetAll(string whereCondition, Dictionary<string, object> parameterValues)
        {
            throw new NotImplementedException();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public override IQueryable<Jahresvergleich> GetAll()
        {
            var dbcontext = new TestatEntities();
            var query = from j in dbcontext.Jahresvergleich select j;
            return query;
        }

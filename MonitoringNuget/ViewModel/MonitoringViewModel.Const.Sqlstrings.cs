namespace MonitoringNuget.ViewModel
{
    public partial class MonitoringViewModel
    {
        ...
        private const string selectDevices = "Select pod.Bezeichnung AS PodName, Device.hostname, Device.ip_adresse, Device.anzahlports"
        ...
        private const string DatabaseName   = "testat";
        private const string LoggingUserId  = "MonitoringWPF";
        private const string LogginPassword = "monitoring123";
    }
}